...
const TestimonialsSectionWhite = () => {
  const CustomPrevArrow = () => (
    <div className="custom-swiper-button-prev size-12 bg-accent-light rounded-sm border border-accent-light flex items-center justify-center cursor-pointer hover:bg-white transition-colors ease-in-out group">
      <FaChevronLeft className="text-white group-hover:text-accent-light transition-colors duration-300 ease-in-out" />
    </div>
  );

  const CustomNextArrow = () => (
    <div className="custom-swiper-button-next size-12 bg-accent-light rounded-sm border border-accent-light flex items-center justify-center cursor-pointer hover:bg-white transition-colors ease-in-out group">
            ...
            {testimonials.map((testimonial: TestimonialsProps) => (
              ...
              >
                <div className="relative overflow-hidden rounded-2xl border border-black/5 h-full flex flex-col justify-end">
                  <div className="relative flex flex-col justify-between gap-10 bg-light h-full p-6 rounded-0">
