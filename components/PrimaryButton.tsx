...
const PrimaryButton = ({ link, text }: PrimaryButtonProps) => {
  return (
    <a
      href={link}
      className="relative flex items-center justify-center w-full gap-2.5 sm:gap-4 p-2.5 sm:p-2 rounded-lg primary-button-gradient overflow-hidden border border-accent-dark hover:border-white transition-colors duration-300 ease-in-out group"
    >
