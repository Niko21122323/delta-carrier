...
const PrimaryButton = ({ link, text }: PrimaryButtonProps) => {
	return (
		<a
			href={link}
			className="relative flex items-center justify-center w-full gap-4 p-2 rounded-lg primary-button-gradient overflow-hidden border border-accent-dark group"
		>
			...
			<div className="relative flex items-center justify-center size-8 bg-white rounded-md overflow-hidden z-10">
