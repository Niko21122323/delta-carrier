...
export const jobs: JobProps[] = [
  {
    ...
    title: "Dispatcher",
    subtitle: "In Office",
    text: "Keep freight moving by coordinating loads, supporting drivers, and ensuring on-time delivery across our network.",
  ...
  },
  {
    ...
    subtitle: "In Office",
    text: "Promote a culture of safety by monitoring compliance, training drivers, and maintaining the highest safety standards.",
    applyLink: "/jobs/apply",
    link: "/jobs/in-office-careers",
    variant: "in-office",
  },
  {
    ...
    text: "Support the business with accurate financial management, from processing settlements to tracking expenses and revenue.",
    applyLink: "/jobs/apply",
    link: "/jobs/in-office-careers",
    variant: "in-office",
  },
  {
    ...
    title: "Recruiting",
    subtitle: "Fleet Operations",
    text: "Help grow our team by finding, screening, and onboarding qualified drivers and staff who share our values.",
    applyLink: "/jobs/apply",
    link: "/jobs/in-office-careers",
    variant: "in-office",
  },
  {
    ...
    subtitle: "Fleet Operations",
    text: "Support our people with HR services including onboarding, employee relations, benefits, and career development.",
    applyLink: "/jobs/apply",
    link: "/jobs/in-office-careers",
    variant: "in-office",
  },
  {
    ...
    title: "IT Department",
    subtitle: "Fleet Operations",
    text: "Keep our technology running smoothly by maintaining systems, solving technical issues, and improving digital tools.",
    applyLink: "/jobs/apply",
    link: "/jobs/in-office-careers",
    variant: "in-office",
  },
  {
    ...
    subtitle: "Fleet Operations",
    text: "Ensure our fleet stays road-ready by providing expert maintenance, inspections, and repair services for all equipment.",
    applyLink: "/jobs/apply",
    link: "/jobs/in-office-careers",
    variant: "in-office",
  },
